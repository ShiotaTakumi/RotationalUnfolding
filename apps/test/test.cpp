...
int main() {
    ...
    poly.adj_edges = {
        {0, 4, 40, 38, 36, 34, 33, 22, 20, 2},
        {2, 19, 1},
        {1, 17, 15, 13, 11, 9, 7, 5, 3, 0},
        {3, 6, 4},
        {5, 8, 49, 47, 45, 43, 42, 41, 40, 6},
        {7, 10, 8},
        {9, 12, 58, 56, 54, 52, 51, 50, 49, 10},
        {11, 14, 12},
        {13, 16, 31, 32, 63, 61, 60, 59, 58, 14},
        {15, 18, 16},
        {17, 19, 20, 21, 23, 25, 27, 29, 31, 18},
        {22, 24, 21},
        {24, 33, 35, 72, 70, 68, 66, 65, 26, 23},
        {26, 28, 25},
        {28, 65, 67, 89, 88, 87, 64, 63, 30, 27},
        {30, 32, 29},
        {34, 37, 35},
        {36, 39, 42, 44, 77, 75, 74, 73, 72, 37},
        {38, 41, 39},
        {43, 46, 44},
        {45, 48, 51, 53, 82, 80, 79, 78, 77, 46},
        {47, 50, 48},
        {52, 55, 53},
        {54, 57, 60, 62, 87, 85, 84, 83, 82, 55},
        {56, 59, 57},
        {61, 64, 62},
        {66, 69, 67},
        {68, 71, 74, 76, 79, 81, 84, 86, 89, 69},
        {70, 73, 71},
        {75, 78, 76},
        {80, 83, 81},
        {85, 88, 86},
    ...
    poly.adj_faces = {
        {2, 3, 4, 18, 17, 16, 12, 11, 10, 1},
        {0, 10, 2},
        {1, 10, 9, 8, 7, 6, 5, 4, 3, 0},
        {2, 4, 0},
        {2, 5, 6, 21, 20, 19, 17, 18, 0, 3},
        {2, 6, 4},
        {2, 7, 8, 24, 23, 22, 20, 21, 4, 5},
        {2, 8, 6},
        {2, 9, 10, 15, 14, 25, 23, 24, 6, 7},
        {2, 10, 8},
        {2, 1, 0, 11, 12, 13, 14, 15, 8, 9},
        {0, 12, 10},
        {11, 0, 16, 17, 28, 27, 26, 14, 13, 10},
        {12, 14, 10},
        {13, 12, 26, 27, 31, 23, 25, 8, 15, 10},
        {14, 8, 10},
        {0, 17, 12},
        {0, 18, 4, 19, 20, 29, 27, 28, 12, 16},
        {0, 4, 17},
        {4, 20, 17},
        {4, 21, 6, 22, 23, 30, 27, 29, 17, 19},
        {4, 6, 20},
        {6, 23, 20},
        {6, 24, 8, 25, 14, 31, 27, 30, 20, 22},
        {6, 8, 23},
        {8, 14, 23},
        {12, 27, 14},
        {12, 28, 17, 29, 20, 30, 23, 31, 14, 26},
        {12, 17, 27},
        {17, 20, 27},
        {20, 23, 27},
        {23, 14, 27},
