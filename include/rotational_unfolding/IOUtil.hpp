...
inline bool loadPolyhedronFromPath(const std::string& base_path, const std::string& category, const std::string& adj, Polyhedron& poly) {
    std::string path = base_path + "/polyhedron/" + category + "/adjacent/" + adj + ".adj";
