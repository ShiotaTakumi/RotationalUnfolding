...
def main():
    ...
    Example usage:
        ...
        python -m rotational_unfolding run --poly data/polyhedra/archimedean/s01 --symmetric on
    
    Output location:
        All output is written to output/<poly_path>/
        This is cwd-independent and always relative to the repository root.
    
    出力場所:
        すべての出力は output/<poly_path>/ に書き込まれる。
