...
PYTHONPATH=reorg/python python -m rotational_unfolding run --poly polyhedra/johnson/n66

# Step 2: Remove isomorphic duplicates (Phase 2)
PYTHONPATH=reorg/python python -m nonisomorphic run --poly polyhedra/johnson/n66
